...
> *This addon and its accompanying custom world are currently in the Alpha stage of development. Features are actively being worked on, and gameplay mechanics are subject to change.*
...
### 🧠 Sanity Mechanic
A mysterious entity currently named **"null"** roams the forest. 
...
A fully custom user interface provides real-time data:
